...
export default function ProductCard({ item }: ProductCardProps) {
  return (
    <div className="relative group">
      ...
      <div className="absolute inset-0 rounded-lg bg-gray-900 opacity-0 group-hover:opacity-50 transition-opacity duration-300"></div>

      {/* Icon in the middle (appears on hover) */}
      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-150 transition-opacity duration-300">
        <div className="border rounded-xl border-white text-white p-1.5">
          <svg
