...
export async function POST(req: Request) {
  try {
    ...
    const requiredFields = ['firstName', 'lastName', 'phone', 'mail', 'gouvernate', 'city', 'adress'];
    const missingFields = requiredFields.filter(field => !body[field as keyof OrderPayload]);
