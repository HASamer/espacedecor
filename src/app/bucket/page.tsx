      ...
      <div>
        ...
        <div className="flex items-center justify-center gap-4">
          <div className="sm:flex sm:gap-4">
            <Link
              href="/"
              className="flex rounded-md bg-blue-900 px-3 py-2.5 text-sm font-medium text-white transition hover:bg-white hover:text-blue-900 border border-blue-900"
            >
              Continue Shopping
              <svg
                      ...
                      <li key={item.id} className="flex items-center shadow p-2 rounded-lg gap-4">
                        ...
                        <div>
                          ...
                          <dl className="space-y-px text-[12px] text-gray-600">
                            <div>
                              ...
                              <dd className="inline">{item.dimension}</dd>
                            </div>

                            <div className="font-medium text-green-600">
                              <dt className="inline">Prix: </dt>
                              <dd className="inline">{item.price} DT</dd>
                            </div>
                          </dl>
                        </div>
                        ...
                        <div className="flex flex-1 items-center justify-end gap-2">
                          ...
                          <button 
                            ...
                            className="text-gray-600 transition hover:text-red-600 border rounded-md border-gray-200 bg-gray-100 p-2 hover:bg-gray-300"
                          >
                  ...
                  <div className="w-screen max-w-lg space-y-4">
                    <dl className="space-y-0.5 text-sm text-blue-900">
                      <div className="flex justify-between">
                        <dt>Items ({state.totalItems})</dt>
                      </div>
                      <div className="flex justify-between !text-base font-medium">
                        <dt>Total</dt>
                        <dd>{state.totalPrice.toFixed(2)} DT</dd>
                      </div>
                    </dl>
